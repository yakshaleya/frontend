...
const Plans = () => {
  ...
  return (
    <div className="container-plans">
      ...
      <h3 className="heading-plans" style={{ textAlign: 'center',fontFamily:'font-family: Montserrat;' }}>Create a Plan</h3>
      ...
      <div className="input-container-plans">
        ...
        <select style={{ width: '260px', color: '#757575' }} value={type} onChange={(e) => setType(e.target.value)}>
          ...
          <option value="High">Type 1</option>
          <option value="Medium">Type 2</option>
          <option value="Low">Type 3</option>
        </select>
      </div>
